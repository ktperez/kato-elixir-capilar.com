$(document).ready(function(){
    ...
    // Manejo del formulario de información del cliente
    $('#client-info-form').submit(function(event){
        ...
        if (name && phone && city) {
            ...
            $.ajax({
                url: '../guardar_registro.php', // URL corregida del script PHP que guarda el registro
                type: 'POST',
                data: {
                    'nombre': name,
                    'telefono': phone,
                ...
                success: function(response){
                    ...
                    alert(response); // Opcional, para mostrar el mensaje de éxito al usuario
                },
    ...
    function sendMessage(){
        ...
        if (userMessage.trim() !== '') {
            ...
            $.ajax({
                url: '../save_message.php', // URL del script PHP que guarda los mensajes
                type: 'POST',
                data: { message: userMessage },
                success: function(response) {
                    console.log("Mensaje guardado en el servidor:", response); // Verificar respuesta del servidor
                },
                error: function(xhr, status, error) {
